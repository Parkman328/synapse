...
class LoginRestServlet(RestServlet):
    ...
    async def _do_other_login(self, login_submission):
        ...
        self.auth_handler().login_submission_legacy_convert(login_submission)
        ...
        medium, address = login_submission.get("medium"), login_submission.get("address")
        ...
        username = self.auth_handler().user_id_from_identifier(
